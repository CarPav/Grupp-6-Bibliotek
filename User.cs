...
namespace GASSIGN_Bibliotekapp
{
    public class User
    {
        ...
        public void CheckoutAndReturnBook()
        {
            ...
            foreach (Book book in UserInterface.books)
            {
            ...
            Book selectedBook = UserInterface.books.FirstOrDefault(b => b.Title.Equals(title, StringComparison.OrdinalIgnoreCase));
